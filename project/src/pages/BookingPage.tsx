    ...
    <div className="min-h-screen bg-gray-50 pt-24 pb-16">
      <div className="container mx-auto px-4">
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold text-gray-800 mb-4">Agende sua consulta</h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Siga os passos abaixo para agendar seu horário no salão. Selecione seu serviço, escolha um estilista, escolha uma data e horário e confirme seu agendamento.
          </p>
          ...
          <div className="flex items-center justify-center mt-8 max-w-3xl mx-auto">
            <div className={`flex flex-col items-center ${currentStep >= 1 ? 'text-purple-600' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center mb-2 ${currentStep >= 1 ? 'bg-purple-600 text-white' : 'bg-gray-200 text-gray-500'
                }`}>
                1
              </div>
            ...
            <div className={`flex flex-col items-center ${currentStep >= 2 ? 'text-purple-600' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center mb-2 ${currentStep >= 2 ? 'bg-purple-600 text-white' : 'bg-gray-200 text-gray-500'
                }`}>
                2
              </div>
              <span className="text-xs">Estilista</span>
            </div>
            ...
            <div className={`flex flex-col items-center ${currentStep >= 3 ? 'text-purple-600' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center mb-2 ${currentStep >= 3 ? 'bg-purple-600 text-white' : 'bg-gray-200 text-gray-500'
                }`}>
                3
              </div>
            ...
            <div className={`flex flex-col items-center ${currentStep >= 4 ? 'text-purple-600' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center mb-2 ${currentStep >= 4 ? 'bg-purple-600 text-white' : 'bg-gray-200 text-gray-500'
                }`}>
                4
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {currentStep === 1 && (
            <div>
              <h2 className="text-2xl font-semibold text-gray-800 mb-6">Selecione um serviço</h2>
          ...
          {currentStep === 2 && (
            <div>
              ...
              <h2 className="text-2xl font-semibold text-gray-800 mb-2">Selecione um estilista</h2>
              <p className="text-gray-600 mb-6">
                Você selecionou: <span className="font-medium text-purple-600">{selectedService?.name}</span>
              </p>
          ...
          {currentStep === 3 && (
            <div>
              <div className="flex items-center mb-6 text-gray-500 hover:text-purple-600 cursor-pointer" onClick={() => navigate('/stylists')}>
                <ChevronRight size={16} className="transform rotate-180 mr-1" />
                <span>Voltar para estilistas</span>
              </div>

              <h2 className="text-2xl font-semibold text-gray-800 mb-2">Selecione Data e Hora</h2>
              <p className="text-gray-600 mb-6">
                Você selecionou: <span className="font-medium text-purple-600">{selectedService?.name}</span> with <span className="font-medium text-purple-600">{selectedStylist?.name}</span>
              </p>
          ...
          {currentStep === 4 && (
            <div>
              ...
              <h2 className="text-2xl font-semibold text-gray-800 mb-6">Confirme sua reserva</h2>
